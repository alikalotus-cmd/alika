(function() {
  ...
  window.renderOrbitWidget = function() {
      ...
      timelineHTML += `
        <div class="flex items-center justify-between p-3 rounded-xl border transition-all ${
          ...
          <div class="flex items-center">
            <button onclick="toggleManualSubject('${subj.id}')" class="px-2.5 py-1 rounded-lg text-[10px] font-bold border cursor-pointer transition-all duration-200 ${
              isPassed
    ...
    const dayData = JADWAL_ORBIT[dayIndex] || JADWAL_ORBIT[1];
